...
export default function Sidebar() {
  ...
  return (
    <div
      id="sidebar_menu"
      className="hidde md:block md:relative rounded-e-2xl md:rounded-none absolute z-40 bg-blue-100 w-[40vw] md:w-full md:bg-gray-200 transition-all duration-500 left-0"
    >
