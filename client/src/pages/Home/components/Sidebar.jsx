...
export default function Sidebar() {
  ...
  return (
    <div
      id="sidebar_menu"
      className="hidde md:block md:relative rounded-e-2xl md:rounded-none absolute z-40 bg-blue-100 md:w-full bg-gray-100 md:border-0 border-y-2 border-r-2 border-blue-200/50 transition-all duration-500 left-0 h-full"
    >
